...
from PySide6.QtCore import Qt, QTimer, QThread, Signal, QSize, QObject
import tomllib

class Controller(QObject):
    show_widgets_signal = Signal()  # 类级别信号
...
if __name__ == "__main__":
    ...
    # 再次检查连接数（此时应输出1）
    #print(f"连接数：{controller.show_widgets_signal.receivers(show_widgets)}")
    print("信號連接數：", controller.receivers("show_widgets_signal"))
