...
# ---------------模拟实际应用的环境(CapsWriter-Offline-GUI)--------------
import sys
sys.path.insert(0, r"C:\Software\CapsWriter-Offline-GUI\site-packages")

# ↓cmd or powershell:
# C:\Software\CapsWriter-Offline-GUI\runtime\python.exe "C:\OneDrive\文档\AHK_Script\Reference\CapsWriter-Offline\history-panel-function-test\016 smart_history_actions_panel(模拟实际应用的环境).py"
# ---------------模拟实际应用的环境(CapsWriter-Offline-GUI)--------------
