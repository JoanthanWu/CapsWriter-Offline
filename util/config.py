...
class ClientConfig:
    ...
    disable_exe_list_on_focus: list[str] = config["client"]["disable_exe_list_on_focus"]
    ...
    sub_activate_panel_shortcut_suppress: str = config["client"]["sub_activate_panel_shortcut_suppress"]
